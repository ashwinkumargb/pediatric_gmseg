...
Description: Run GM model on non-augmented data based on early stopping with no pretraining.
...
# %%
#Load in the data
train_data = expand_dims(shape_and_norm(np.load('../data/train_data.npy')))
train_targets = expand_dims(shape_and_norm(np.load('../data/train_targets.npy').astype('float32'), False))
val_data = expand_dims(shape_and_norm(np.load('../data/val_data.npy')))
val_targets = expand_dims(shape_and_norm(np.load('../data/val_targets.npy').astype('float32'), False))
